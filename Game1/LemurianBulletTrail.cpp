...
LemurianBulletTrail::LemurianBulletTrail()
{
...
void LemurianBulletTrail::Update()
{
...
void LemurianBulletTrail::Render()
{
    if (not isPlaying) return;
...
void LemurianBulletTrail::RenderDetail()
{
